...
function injectMe() { // This is needed to make this script work in Chrome.
	...
	var bbb = { // Container for script info.
		...
		options: { // Setting options and data.
			...
			show_deleted: new Option("checkbox", true, "Show Deleted", "Display all deleted images in the search, pool, popular, and notes listings."),
			show_loli: new Option("checkbox", true, "Show Loli", "Display loli images in the search, pool, popular, comments, and notes listings."),
